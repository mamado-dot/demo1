      ...
      <div className="bg-white p-4 sm:p-6 rounded-3xl border border-slate-200/80 shadow-xs flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div className="flex items-center gap-3">
          <button
            ...
            className="inline-flex items-center gap-2 px-3.5 py-2 rounded-2xl bg-slate-100 hover:bg-slate-200 text-slate-800 font-bold text-xs transition-all cursor-pointer border border-slate-200/60"
          >
      ...
      {favoriteItems.length > 0 ? (
        <div className="space-y-4">
          ...
          <div className="flex items-center justify-between px-2 text-xs font-bold text-slate-500">
            <span>عرض {favoriteItems.length} عنصر في مفضلتك</span>
            <span className="text-slate-400">انقر على بطاقة أي عنصر لاستعراض تفاصيله أو طلب مقايضته</span>
          </div>
